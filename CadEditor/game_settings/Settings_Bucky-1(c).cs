...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return Utils.getVideoChunk(new[] {"chr1(d).bin", "chr1(e).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return Utils.readPalFromBin(new[] {"pal1(e).bin"}); }
}