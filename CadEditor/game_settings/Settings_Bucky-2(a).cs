...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return Utils.getVideoChunk(new[] {"chr2(a).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return Utils.readPalFromBin(new[] {"pal2(a).bin", "pal2(b).bin"}); }
}