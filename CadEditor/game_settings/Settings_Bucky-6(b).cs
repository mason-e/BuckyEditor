...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return Utils.getVideoChunk(new[] {"chr6(b).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return Utils.readPalFromBin(new[] {"pal6(b).bin"}); }
}