...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return Utils.getVideoChunk(new[] {"chr4(b).bin", "chr4(c).bin", "chr4(d).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return Utils.readPalFromBin(new[] {"pal4(c).bin", "pal4(d).bin", "pal4(e).bin"}); }
}