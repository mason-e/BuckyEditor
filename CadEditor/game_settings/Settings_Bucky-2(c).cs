...
{ 
  ...
  public GetVideoChunkFunc    getVideoChunkFunc()    { return Utils.getVideoChunk(new[] {"chr2(b).bin", "chr2(c).bin"}); }
  ...
  public GetPalFunc           getPalFunc()           { return Utils.readPalFromBin(new[] {"pal2(b).bin", "pal2(c).bin", "pal2(d).bin"}); }
}